...
import { ConfigService, HtmlElementHelper, InputService, LabelsHelper, NewMagicItem, PageService, PageServiceFactory } from '../../core';
import { DdbHelper } from './ddb.helper';

@Injectable()
export class DdbMagicItemsInput implements InputService<NewMagicItem> {
  sourceId: string = 'DDB';
  ...
  async *getAll(): AsyncGenerator<NewMagicItem> {
  ...
  private async getMagicItemFromDetailPage(url: string): Promise<NewMagicItem> {
